...
include_once('../php/VTPaisesIsoScript.php');
...
<title>ISO Países tutoriales. Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > ISO Países Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="VTPaisesIsoLista.php" method="post">';
    ...
    $query = 'show columns FROM vtpaisesiso';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "select id, iso, nombre from vtpaisesiso  where id = %d";
...
echo "<div class ='clear'></div>";
echo "<br><br><div class ='TituloRegistro' >";
