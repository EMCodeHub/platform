...
function Posicionate() {
	document.getElementById("id_forosmensajes").focus(); 
}
...
echo "<div class = 'TituloCurso' > Foros: Recursos Registro Núm ".$_REQUEST['registro_recurso'];

echo "</div>";
echo "<br>";
?>
	
<form id = "datos" name= "datos"  action="ForosRecursosLista.php" method="post">  
...
if ($_REQUEST['alta'] == 1) {
	      ...
	      //.....................
			...
			if ($CampoMombre[$i] == 'id_forosmensajes') {
				echo elinput($CampoMombre[$i],$_REQUEST['registro_mensaje'], $CampoTipo[$CampoMombre[$i]],$conexion);  
			} else {
   ...
   $queMaestros = sprintf($FormatMaestros, $_REQUEST['registro_recurso']); 
