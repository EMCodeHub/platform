...
<head>
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="UsuariosFicha.php";
	   ...
	   function altaRegistro(reg) {
	      ...
	      function Selecciona(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="UsuariosLista.php";
		   document.datos.submit();
	   }
...
include_once('../php/UsuariosScrip.php');
 ///...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.empieza body
...
<br>
<div class="TituloLista">Usuarios</div>
<div class = TituloTablaUsuario> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nuevo usuario" type="button" value ="Alta nuevo usuario" onClick="altaRegistro()" />
</div>

<div class = Separador> &nbsp;</div><br>

<div class="envoltorioUsuario">

<?php

pintaUsuarios($conexion);
...
<div class = TituloTablaUsuario >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nuevo usuario" type="button" value ="Alta nuevo usuario" onClick="altaRegistro()" /></div>
</div>
</form>
