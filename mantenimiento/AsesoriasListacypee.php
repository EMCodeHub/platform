...
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="AsesoriasFichacypee.php";
	   ...
	   /* document.getElementById('RecetaID').value = 0; */
	      ...
	      function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="AsesoriasListacypee.php";
...
<title>ASESORÍAS: Agenda de llamada para ESTUDIANTES</title>
...
<div class="TituloLista">ASESORÍAS: Agenda de llamada para ESTUDIANTES </div>
