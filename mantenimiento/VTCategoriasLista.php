...
<head>
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="VTCategoriasFicha.php";
	   ...
	   function altaRegistro(reg) {
	      ...
	      function Selecciona(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="VTCategoriasLista.php";
		   document.datos.submit();
	   }
...
<title>Lista de Categorías para clasificar videotutoriales</title>
<link href="../css/estilosMantenimiento.css" rel="stylesheet" type="text/css" />
</head>
<?php

include_once('../php/VTCategoriasScrip.php');
 ///...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.empieza body
...
<br>
<div class="TituloLista">Categorías de videotutoriales</div>
<div class = TituloTablaSubfichero> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva Categoría" type="button" value ="Alta nueva Categoría" onClick="altaRegistro()" />
</div>
...
pintaVTCategoriasDemo($conexion);
...
<div class = TituloTablaSubfichero >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva Categoría" type="button" value ="Alta nueva Categoría" onClick="altaRegistro()" /></div>
</div>
</form>
