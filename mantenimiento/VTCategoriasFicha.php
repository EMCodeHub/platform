...
<title>Categorías de Videotutoriales. Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Categorías de Videotutoriales Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="VTCategoriasLista.php" method="post">';
    ...
    $query = 'show columns FROM vtcategorias';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "select id, esta_activo, orden, descripcion from vtcategorias  where id = %d";
