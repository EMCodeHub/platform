...
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="VTFacturasManualesFicha.php";
	   ...
	   /* document.getElementById('RecetaID').value = 0; */
	      ...
	      function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="VTFacturasManualesLista.php";
...
<title>VIDEOTUTORIALES: Edición facturas cobros manuales</title>
...
<div class="TituloLista">VIDEOTUTORIALES: Edición facturas cobros manuales </div>
<div class = "TituloTablaFacturaM"> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp;


<input name="Alta Factura" type="button" value ="Alta Factura" onClick="altaRegistro()" />
...
<?php
pintaFacturasManuales($conexion);
?>
</div>

<div class = "TituloTablaFacturaM" >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta Factura" type="button" value ="Alta Factura" onClick="altaRegistro()" /></div>
</div>
</form>
