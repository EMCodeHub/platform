...
<title>Modalidades de curso.Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Modalidades Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="ModalidadLista.php" method="post">';
    ...
    $query = 'show columns FROM modalidadcurso';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id,	descripcion from modalidadcurso  where id = %d";
