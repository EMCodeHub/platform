...
include_once('../php/VTRecursosScrip.php');
...
<SCRIPT LANGUAGE="JavaScript"> 
	function volver() {
		<?php if ($_REQUEST['volver_a'] != "") { ?>
		 ...
		 <?php } else { ?>
		   location.href='VTRecursosLista.php';
		   <?php }?> 
...
//................................................
	   ...
	   function procesar(sino) {
		  ...
		  if (sino == 1){
	             ...
	             if (trim(document.getElementById("titulo_recurso").value).length < 5) {
	             	alert ("NO PROCESADO: Título demasiado corto");
	             	return;
	             }
	            
				 
				 if (trim(document.getElementById("nomfic_recurso").value).length < 5) {
...
<title>Recursos-Videotutoriales. Edición de Registros</title>
...
<table width="90%" border="0">
  ...
  <tr>
    <td class="informacionFicheros" width="7%"><b>RECURSO:</b></td>
    <td class="informacionFicheros" width="92%"><?php echo "En pantalla .....(Gereralmente UN DGW, RAR, ZIP) .....";?>	</td>
  </tr>
...
<?php
echo "<div class = 'TituloCurso' > RECURSOS-Videotutoriales Registro Núm ".$_REQUEST['registro'];
echo "</div>";
echo "<br>";

	
	echo '<form id = "datos" name= "datos" action="VTRecursosLista.php" method="post">';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id, esta_activo, id_vtcurmodbloque, orden_recurso, es_de_pago, titulo_recurso, nomfic_recurso  FROM vtcurmodbloqrecurso  where  id = %d";
