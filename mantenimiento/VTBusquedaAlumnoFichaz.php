...
if (!isset($_REQUEST['volver_a'])) {
	$_REQUEST['volver_a'] = "VTBusquedaAlumnoListaz.php";
} else {
...
//................................................
	...
	//.........................
	   function VerPermisos(registro) {
		   document.getElementById("volver_a").value = "VTBusquedaAlumnoFichaz.php?registro="+registro;
...
echo "<br>";
	...
	echo '<form id = "datos" name= "datos" action="VTBusquedaAlumnoListaz.php" method="post">';
