...
<title>Precios por la compra de más de un curso. Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Precios lote de cursos. Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="VTPrecioLoteLista.php" method="post">';
    ...
    $query = 'show columns FROM vtpreciolote';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "select id, num_cursos, precio_lote from vtpreciolote  where id = %d";
