	...
	function volver() {
	   ...
	   function edita(reg) {
		   ...
		   document.getElementById('alta').value = 0;
		    document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="VTTemasFicha.php";
		   document.datos.submit();
	   }
...
<title>Temas  Videotutoriales</title>
...
<input name="Alta nuevo Tema-Videotutorial" type="button" value ="Alta nuevo Tema-Videotutorial" onClick="altaRegistro()" />&nbsp; &nbsp; 
...
<div class = "TituloTablaVTBloque" >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "volver()" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nuevo Tema-Videotutorial" type="button" value ="Alta nuevo Tema-Videotutorial" onClick="altaRegistro()" /></div>
</div>
</form>
