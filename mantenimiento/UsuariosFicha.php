...
<title>Usuarios.Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Usuarios Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<br>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="UsuariosLista.php" method="post">';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id,	nombre_usuario, pwd,	es_admin,	referencia_interna,	fecha_alta,	fecha_baja  from usuarios  where id = %d";
