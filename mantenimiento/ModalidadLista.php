...
<head>
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="ModalidadFicha.php";
	   ...
	   function altaRegistro(reg) {
	      ...
	      function Selecciona(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ModalidadLista.php";
		   document.datos.submit();
	   }
...
<title>Lista Modalidades de cursos</title>
<link href="../css/estilosMantenimiento.css" rel="stylesheet" type="text/css" />
</head>
<?php

include_once('../php/ModalidadesScrip.php');
 ///...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.empieza body
...
<br>
<div class="TituloLista">Modalidad curso</div>
<div class = TituloTablaSubfichero> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva modalidad" type="button" value ="Alta nueva modalidad" onClick="altaRegistro()" />
</div>
...
<div class = TituloTablaSubfichero >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva modalidad" type="button" value ="Alta nueva modalidad" onClick="altaRegistro()" /></div>
</div>
</form>
