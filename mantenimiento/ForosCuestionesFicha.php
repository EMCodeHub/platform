...
//................................................
	...
	//.........................
	   function VerMensajes(registro) {
		   document.getElementById("volver_cuestion").value = "ForosCuestionesFicha.php?registro_tema="+registro;
...
function Posicionate() {
	document.getElementById("id_forostemas").focus(); 
}
...
echo "<div class = 'TituloCurso' > Foros: Cuestiones Registro Núm ".$_REQUEST['registro_cuestion'];
echo '&nbsp; &nbsp; &nbsp;<input name="Ver Mensajes" type="button" value ="Ver Mensajes" onClick="VerMensajes('.$_REQUEST['registro_cuestion'].')" />';

echo "</div>";
echo "<br>";
?>
	
<form id = "datos" name= "datos"  action="ForosCuestionesLista.php" method="post">  
...
if ($_REQUEST['alta'] == 1) {
	      ...
	      //.....................
			...
			if ($CampoMombre[$i] == 'id_forostemas') {
				echo elinput($CampoMombre[$i],$_REQUEST['registro_tema'], $CampoTipo[$CampoMombre[$i]],$conexion);  
			} else {
