...
<head>
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="PeriodicidadCursoFicha.php";
	   ...
	   function altaRegistro(reg) {
	      ...
	      function Selecciona(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="PeriodicidadCursoLista.php";
		   document.datos.submit();
	   }
...
<title>Lista Periodicidades de cursos</title>
<link href="../css/estilosMantenimiento.css" rel="stylesheet" type="text/css" />
</head>
<?php

include_once('../php/PeriodicidadCursoScrip.php');
 ///...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.empieza body
...
<br>
<div class="TituloLista">Periodicidades de curso</div>
<div class = TituloTablaSubfichero> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva Periodicidad" type="button" value ="Alta nueva Periodicidad" onClick="altaRegistro()" />
</div>
...
pintaPeriodicidadCurso($conexion);
...
<div class = TituloTablaSubfichero >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nueva Periodicidad" type="button" value ="Alta nueva Periodicidad" onClick="altaRegistro()" /></div>
</div>
</form>
