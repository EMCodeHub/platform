...
<head>
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="OrganizadorFicha.php";
	   ...
	   function altaRegistro(reg) {
	      ...
	      function Selecciona(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="OrganizadorLista.php";
		   document.datos.submit();
	   }
...
<title>Lista Locales Organizadores de cursos</title>
<link href="../css/estilosMantenimiento.css" rel="stylesheet" type="text/css" />
</head>
<?php

include_once('../php/OrganizadorScrip.php');
 ///...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.empieza body
...
<br>
<div class="TituloLista">Locales organizadores</div>
<div class = TituloTablaOrganizador> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Nuevo Local Organizador" type="button" value ="Nuevo Local Organizador" onClick="altaRegistro()" />
</div>
<div class = Separador> &nbsp;</div><br>

<div class="envoltorioOrganizador">

<?php

pintaOrganizadores($conexion);
...
<div class = TituloTablaOrganizador >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Nuevo Local Organizador" type="button" value ="Nuevo Local Organizador" onClick="altaRegistro()" /></div>
</div>
</form>
