	...
	function volver() {
	   ...
	   function edita(reg) {
		   ...
		   document.getElementById('alta').value = 0;
		    document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="VTRecursosFicha.php";
		   document.datos.submit();
	   }
...
<title>Recursos  Videotutoriales</title>
...
<input name="Alta nuevo Recurso" type="button" value ="Alta nuevo Recurso" onClick="altaRegistro()" />&nbsp; &nbsp; 
...
<div class = "TituloTablaVTBloque" >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "volver()" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta nuevo Recurso" type="button" value ="Alta nuevo Recurso" onClick="altaRegistro()" /></div>
</div>
</form>
