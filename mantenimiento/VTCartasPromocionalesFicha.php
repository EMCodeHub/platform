...
if (!isset($_REQUEST['volver_a'])) {
	$_REQUEST['volver_a'] = "CartasPromocionalesLista.php";
} else {
...
//................................................
	   ...
	   function procesar(sino) {
		  if (sino == 1){
	   	...
	   	//.........................
	   function VerCartasAlumnos(registro) {
		   document.getElementById("volver_a").value = "VTAlumnosFicha.php?registro="+registro;
		   document.getElementById('operacion').value = 'NADA';
		   document.getElementById('filtro').value = "FILTRO_ID";
		   URL = "VTCartasRelacionAlumnos.php?NumeroCarta="+registro;
	       window.open(URL,"Cartas Promocionales Enviadas","width=1000,height=700,scrollbars=YES,resizable=YES,LEFT=200,TOP=100") 	   
	   }
//................................
...
<title>Cartas Promocionales. Visualización de Registros</title>
...
echo "<div class = 'TituloCurso' > Cartas Promocionales Registro Núm ".$_REQUEST['registro'];
echo '&nbsp; &nbsp; &nbsp;<input name="VerCartasEnviadas" type="button" value ="Ver Cartas Enviadas" onClick="VerCartasAlumnos('.$_REQUEST['registro'].')" />';

echo "</div>";
echo "<br>";

	
	echo '<form id = "datos" name= "datos" action="VTCartasPromocionalesLista.php" method="post">';
    ...
    $query = 'show columns FROM  vtcartascabecera';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id, fichero, f_creacion, f_ultimoenvio, asunto, afegirnombre, numalumnos, seleccion, tienen, notienen, query 
...
echo '<input name="cancelar" type="button" value ="Salir" onClick="procesar(0)" />';
