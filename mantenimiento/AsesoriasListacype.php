...
include_once('../php/AsesoriasScripcype.php');
?>
<!doctype html>
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="AsesoriasFichacype.php";
	   ...
	   /* document.getElementById('RecetaID').value = 0; */
	      ...
	      function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="AsesoriasListacype.php";
...
<title>ASESORÍAS: Agenda de llamada para PROFESIONALES</title>
...
<div class="TituloLista">ASESORÍAS: Agenda de llamada Para PROFESIONALES </div>
