...
<title>Emails Comerciales.Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Emails Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<br>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="EmailsLista.php" method="post">';
...
if ($_REQUEST['alta'] == 1) {
   ...
   puerto, seguridad, requiere_auth, usuario, password, usa_logo, fichero_logo, tipocorreo from emailscomerciales  where id = %d";
