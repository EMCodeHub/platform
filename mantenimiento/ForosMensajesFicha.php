...
//................................................
	...
	//.........................
	   function VerRecursos(registro) {
		   document.getElementById("volver_mensaje").value = "ForosMensajesFicha.php?registro_mensaje="+registro;
...
function Posicionate() {
	document.getElementById("id_foroscuestiones").focus(); 
}
...
<title>Foros: Recursos - Edición de Registros</title>
...
echo "<div class = 'TituloCurso' > Foros: Mensajes Registro Núm ".$_REQUEST['registro_mensaje'];
echo '&nbsp; &nbsp; &nbsp;<input name="Ver Recursos" type="button" value ="Ver Recursos" onClick="VerRecursos('.$_REQUEST['registro_mensaje'].')" />';

echo "</div>";
echo "<br>";
?>
	
<form id = "datos" name= "datos"  action="ForosMensajesLista.php" method="post">  
...
if ($_REQUEST['alta'] == 1) {
	      ...
	      //.....................
			...
			if ($CampoMombre[$i] == 'id_foroscuestiones') {
				echo elinput($CampoMombre[$i],$_REQUEST['registro_cuestion'], $CampoTipo[$CampoMombre[$i]],$conexion);  
			} else {
