...
//.................................................
include_once('../php/ForosRecursosScrip.php');
?>
<!doctype html>
<html lang="es">
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   document.getElementById('registro_recurso').value = reg; 
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ForosRecursosFicha.php";
		   document.datos.submit();
	   }
	   function altaRegistro(reg) {
		   document.getElementById('registro_recurso').value = 0;
	   ...
	   function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ForosRecursosLista.php";
		   document.datos.submit();
	   }
	function SeleccionaMensaje(campo) {
		   document.getElementById('registro_mensaje').value = campo.value;
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ForosRecursosLista.php";
...
<div class="TituloLista">Foros: Recursos</div>
    
<div class = "TituloTablaForoCues"> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='<?php echo Volver() ?>'" /> &nbsp; &nbsp; &nbsp; &nbsp;

<input name="Alta Recurso" type="button" value ="Alta Recurso" onClick="altaRegistro()" />

&nbsp; &nbsp;Seleccionar Mensaje:  <?php echo hazSelectIndiceFiltro("forosmensajes","id",$_REQUEST['registro_mensaje'],$conexion,"mensajeID",1,1); ?>
...
?>    
<input type="checkbox" id="check_pendientes" <?php echo $chequeado ?> onChange="SeleccionaPendientes(this)"> Seleccionar PENDIENTES de revisar
...
<input name="Alta Recurso" type="button" value ="Alta Recurso" onClick="altaRegistro()" /></div>
</div>
</form>
