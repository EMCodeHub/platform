...
<title>Programas demo CYPE. Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Programas Demo Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="ProgramasDemoLista.php" method="post">';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "select id, esta_activo, descripcion from programasdemos  where id = %d";
