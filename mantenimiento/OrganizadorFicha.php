...
<title>Organizadores (Dirección Aula) de curso.Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Organizadores (Direccon Aula) Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="OrganizadorLista.php" method="post">';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id,	descripcion_interna,	nombre_organizador,	pais,	ciudad,	lugar, direccion,	pers_contacto, tfn_contacto from organizadores  where id = %d";
