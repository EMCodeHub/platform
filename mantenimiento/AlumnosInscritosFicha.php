...
<title>E-mails, inscripciones a cursos. Edición de Registros</title>
...
<?php
echo "<div class = 'TituloCurso' > Alumnos/Clientes Registro Núm ".$_REQUEST['registro'];
echo "</div>";
echo "<br>";

	
	echo '<form id = "datos" name= "datos" action="AlumnosInscritosLista.php" method="post">';
...
ciudad, precio_tarifa, precio_real, aplicado_descuento, fichero_zipdwg   from alumnosinscritos   where id = %d";
