...
<title>Periodicidad de cursos. Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Periodicidad de Curso Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="PeriodicidadCursoLista.php" method="post">';
    ...
    $query = 'show columns FROM periodocursos';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id,	descripcion from periodocursos  where id = %d";
