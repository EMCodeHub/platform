...
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="VTFacturasPagosGastosFicha.php";
	   ...
	   /* document.getElementById('RecetaID').value = 0; */
	      ...
	      function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="VTFacturasPagosGastosLista.php";
...
<title>VIDEOTUTORIALES: Edición facturas pagadas</title>
...
<div class="TituloLista">VIDEOTUTORIALES: Edición facturas pagadas </div>
<div class = "TituloTablaFacturaM"> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp;


<input name="Alta Gasto" type="button" value ="Alta Gasto" onClick="altaRegistro()" />
...
<div class = "TituloTablaFacturaM" >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta Gasto" type="button" value ="Alta Gasto" onClick="altaRegistro()" /></div>
</div>
</form>
