...
//.................................................
include_once('../php/ForosCuestionesScrip.php');
?>
<!doctype html>
<html lang="es">
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   document.getElementById('registro_cuestion').value = reg; 
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ForosCuestionesFicha.php";
	...
	function SeleccionaTema(campo) {
		   document.getElementById('registro_tema').value = campo.value;
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="ForosCuestionesLista.php";
...
<div class="TituloLista">Foros: Cuestiones</div>
    
<div class = "TituloTablaForoCues"> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='<?php echo Volver() ?>'" /> &nbsp; &nbsp; &nbsp; &nbsp;

<input name="Alta Cuestión" type="button" value ="Alta Cuestión" onClick="altaRegistro()" />

&nbsp; &nbsp;Seleccionar Tema:  <?php echo hazSelectIndiceFiltro("forostemas","id",$_REQUEST['registro_tema'],$conexion,"temaID",1,1); ?>
...
<input name="Alta Cuestión" type="button" value ="Alta Cuestión" onClick="altaRegistro()" /></div>
</div>
</form>
