...
if (!isset($_REQUEST['volver_a'])) {
	$_REQUEST['volver_a'] = "formulariolista.php";
} else {
...
//.....................................................
	   ...
	   function procesar(sino) {
		  if (sino == 1){
			  ...
			  document.getElementById("pais").value = (document.getElementById("pais").value).toUpperCase();
...
echo "<div class = 'TituloCurso' > Comentarios subidos manualmente Núm ".$_REQUEST['registro'];
echo "</div>";
echo "<br>";

	
	echo '<form id = "datos" name= "datos" action="formulariolista.php" method="post">';
