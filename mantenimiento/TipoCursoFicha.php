...
<title>Tipos de curso.Edición de Registros</title>
...
<?php
echo "<div class = TituloRegistro > Tipos de Curso Registro Núm ".$_REQUEST['registro'] ."</div>";
echo "<div class ='clear'></div>";
	include_once('../conexion/conn_bbdd.php');
	
	echo '<form id = "datos" name= "datos" action="TipoCursoLista.php" method="post">';
    ...
    $query = 'show columns FROM tipocurso';
...
if ($_REQUEST['alta'] == 1) {
   ...
   $FormatMaestros = "SELECT id,	descripcion from tipocurso  where id = %d";
