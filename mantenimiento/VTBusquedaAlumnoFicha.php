...
if (!isset($_REQUEST['volver_a'])) {
	$_REQUEST['volver_a'] = "VTBusquedaAlumnoLista.php";
} else {
	if ($_REQUEST['volver_a']="") {
	    $_REQUEST['volver_a'] = "VTBusquedaAlumnoLista.php";	
	}
}
include_once('../php/VTBusquedaAlumnoScrip.php');
...
//................................................
	...
	//.........................
	   function VerPermisos(registro) {
		   document.getElementById("volver_a").value = "VTBusquedaAlumnoFicha.php?registro="+registro;
...
echo "<br>";
	...
	echo '<form id = "datos" name= "datos" action="VTBusquedaAlumnoLista.php" method="post">';
