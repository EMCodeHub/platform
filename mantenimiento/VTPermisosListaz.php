...
if (!isset($_REQUEST['volver_a'])) {
	...
	if ($_REQUEST['volver_a'] == "" || $_REQUEST['volver_a'] == "VTPermisosListaz.php") {
		$_REQUEST['volver_a'] = "mantenimiento.php";
	}
}
...
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.getElementById('volver_a').value = "VTPermisosListaz.php";
		   document.datos.action="VTPermisosFichaz.php";
