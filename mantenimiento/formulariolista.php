...
include_once('../php/formularioscript.php');
?>
<!doctype html>
<html lang="es">
      ...
      <SCRIPT LANGUAGE="JavaScript"> 
	   function edita(reg) {
		   ...
		   document.datos.action="formularioficha.php";
	   ...
	   /* document.getElementById('RecetaID').value = 0; */
	      ...
	      function SeleccionaPorFecha(campo) {
		   ...
		   document.getElementById('alta').value = 0;
		   document.getElementById('filtro').value = "FILTRO_ID";
		   document.datos.action="formulariolista.php";
...
<title>FORMULARIO: Respuestas de alumnos</title>
...
<div class="TituloLista">GESTIÓN DE FORMULARIOS RECIBIDOS </div>
<div class = "TituloTablaFacturaM"> &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp;


<input name="Alta Factura" type="button" value ="Nuevo Comentario" onClick="altaRegistro()" />
...
<div class = "TituloTablaFacturaM" >  &nbsp; &nbsp;
<input name="Anterior" type="button" value ="Volver" onClick = "location.href='mantenimiento.php'" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input name="Alta Factura" type="button" value ="Nuevo Comentario" onClick="altaRegistro()" /></div>
</div>
</form>
