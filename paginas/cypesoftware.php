...
include_once('ClassAsesoriaSesioncype.php');
...
<title>Adquirir Licencia CYPE</title>
...
<script type='text/javascript' src="../php/AsesoriaSesioncype.js"></script>        
<?php
        ...
        eventClick: function (calEvent, jsEvent, view) {
            ...
            $('#modal-event').modal();*/
             <?php if ($_SESSION['es_admin'] == 1 || $_SESSION['es_colaborador'] == 1) { 
                echo 'window.location.href = "../mantenimiento/AsesoriasListacype.php";';
             } ?>
        },  
	});
});
...
<script  src="../php/VideotutorialesLoginNOIndexAsesorias.js"></script> 
    <h1 class ="NewtituloApartado">Adquirir CYPE por suscripción</h1>
    <br>
 <div id="AsesoriasCalendario"> 
  ...
  <source src="../video/CYPEllamada.mp4" type="video/mp4">
...
Your browser does not support the video tag.
     ...
     <div id="CalendarioRight">
         <div id="calendar"></div>
         <div  id="AsesoriaForm"><?php include_once('AsesoriasFormulariocype.php'); ?></div>
     </div>
...
<div class="separador"></div> <div class="separador"></div> 
    ...
    <div class="ficha_aula_box_inferior">
        ...
        <ul>
            <li class="asesoria_lista">Mediante la llamada conocerá exactamente en qué consite la propuesta de pago por suscripción para <span class = "azulNegreta">obtener la licencia de CYPE de forma permanente</span> junto con un plan personalizado de capacitación.</li>
            <li class="asesoria_lista">Comenzarás a elaborar proyectos con seguridad <span class = "azulNegreta">pudiendo amortizar el precio de la herramienta elaborando proyectos en su consultoría privada.</span></li>
