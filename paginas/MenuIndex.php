<div id="logoMedif"><img src="imagenes/logos/<?php echo $DatosWeb->GetTrimValor('web_logocolor') ?>"  alt="Logo <?php echo $DatosWeb->GetTrimValor('web_dominio') ?>" /> </div>
<?php
...
<div class="menu_bar" onClick="VerNav()">
  ...
  <svg width="5%" height="100%" viewBox="0 0 74 74">
...
<?php if ($_SESSION['NumeroUsuario'] == 0) { ?> 
  <div class="menu" onclick="VerNav(); VerLogin(1)">LOGIN</div>
<?php } ?>   
<?php echo $DatosWeb->EscribeMenu("") //La carpeta raíz está vacía  ?>
</nav>
