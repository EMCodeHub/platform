...
if ($modulo == 0) {
	  ...
	  echo "<a href='".$DatosWeb->GetTrimValor('web_url')."/paginas/AsesoriasYObras.php'>".$DatosWeb->GetTrimValor('web_dominio')."</a>";
...
//............................................actualizar asesoriassesiones: f_confirmacion, id_alumno
   $FormatTemas = "UPDATE asesoriasesiones set 
                          f_confirmacion  = '%s',
                          id_alumno = %d
                    WHERE id= %d";
  ...
  <div class="centro"> 
       ...
       <br />
         <?php if($Dia >= date('Y-m-d')) {  ?>
              <b>Queda confirmada la VideoConferencia para el día <?php echo $Dia ?> a las <?php echo $Hora ?> horas</b>
         <?php  } else {  ?>
        ...
        <?php if($altaNueva == 1){ ?>
             ...
             <p> <a href="<?php echo $DatosWeb->GetTrimValor('web_url') ?>/paginas/AsesoriasYObras.php">Puedes utilizar este usuario para futuras reservas</a></p>
        <?php } ?>
        
    </div>
  <img src="../imagenes/AsesoriaSesion.jpg"  alt="Foro" />
