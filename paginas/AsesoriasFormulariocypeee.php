...
<div  id="AsesoriaForm1">
     <div class="centro">
         <b>Reserva de llamada (hora de su país)</b>
    </div>
</div>
<div  id="AsesoriaForm2">
    ...
    Hora inicio:
          ...
          <span class="textoAzul">Duración aproximada de 30 minutos</span>  
</div>
...
<div  id="AsesoriaForm4">
    ...
    <div class="Sesion100">
        ...
        <div class="SesionD"><input id="SesCorreo" class="inputRedondo" name="SesCorreo" type="text" size=30 type="text" placeholder="¿Correo Electrónico?" value = "<?php echo $ICorreo ?>"/></div>
        <div class="clear"></div>
     </div>
     <div class="Sesion100">
        <div class="SesionI">Teléfono</div>
        <div class="SesionD"><input id="SesTelefono" class="inputRedondo" name="SesTelefono" type="text" size=30 type="text" placeholder="¿Numero celular?" value = "<?php echo $ITelefono ?>"/></div>
        <div class="clear"></div>
     </div>
      ...
      <div class="Sesion100">
        ...
        <div class="SesionD"><input id="SesNombre" class="inputRedondo" name="SesNombre" type="text" size=30 type="text" placeholder="¿Nombre?" value = "<?php echo $INombre ?>"/></div>
        <div class="clear"></div>
     </div>
    <div class="Sesion100">
        <div class="SesionI">Apellidos</div>
        <div class="SesionD"><input id="SesApellidos" class="inputRedondo" name="SesApellidos" type="text" size=30 type="text" placeholder="¿Apellidos?" value = "<?php echo $IApellidos ?>"/></div>
        <div class="clear"></div>
     </div>
    <div class="Sesion100">
        <div class="SesionI">Ciudad</div>
        <div class="SesionD"><input id="SesCiudad" class="inputRedondo" name="SesCiudad" type="text" size=30 type="text" placeholder="¿Ciudad?" value = "<?php echo $ICiudad ?>"/> </div>
        <div class="clear"></div>
     </div>
    <div class="Sesion100">
        <div class="SesionI">País</div>
        <div class="SesionD"><input id="SesPais" class="inputRedondo" name="SesPais" type="text" size=30 type="text" placeholder="¿País?" value = "<?php echo $IPais ?>"/> </div>
        <div class="clear"></div>
     </div>
     <div class="Sesion100">
        <div class="SesionI">Datos adicionales sobre usted</div>
        <div class="SesionD">
            <textarea name="SesObservaciones" id = "SesObservaciones" cols="30" rows="8"></textarea>
        </div>
        <div class="clear"></div>
     </div>
