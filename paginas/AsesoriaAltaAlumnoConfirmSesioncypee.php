...
if ($modulo == 0) {
	  ...
	  echo "<a href='".$DatosWeb->GetTrimValor('web_url')."/paginas/cype-software.php'>".$DatosWeb->GetTrimValor('web_dominio')."</a>";
...
//............................................actualizar asesoriassesiones: f_confirmacion, id_alumno
   $FormatTemas = "UPDATE compracypealumnos set 
                          f_confirmacion  = '%s',
                          id_alumno = %d
                    WHERE id= %d";
  ...
  <div class="centro"> 
       ...
       <br />
        ...
        <?php if($altaNueva == 1){ ?>
             ...
             <p> <a href="<?php echo $DatosWeb->GetTrimValor('web_url') ?>/paginas/cype-software.php">Puedes utilizar este usuario para futuras reservas</a></p>
        <?php } ?>
        
    </div>
  <img src="../imagenes/CypeUltimaVersion3.jpg"  alt="Foro" />
