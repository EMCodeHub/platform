...
$captchaImage = imagecreatefrompng( "../imagenes/captcha/captcha.png" );
...
$textColor = imagecolorallocate( $captchaImage, 50, 118, 200 );
...
$imageInfo = getimagesize( "../imagenes/captcha/captcha.png" );
...
imagettftext( $captchaImage, 20, 0, 15, 35, $textColor, "../imagenes/captcha/VeraBd.ttf", $key );
