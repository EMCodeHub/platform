...
$url_formulario = "https://medifestructuras.com/paginas/AsesoriaAltaAlumnoConfirmSesioncypeee.php?Referencia=".rawurlencode($Referencia);
...
<table width="100%" border="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
  <tr>
    <td width="6%" rowspan="6"><img src="https://medifestructuras.com/imagenes/logos/LogoMedif.jpg" width="100" height="100"></td>
    <td width="1%" rowspan="6">&nbsp;</td>
    <td width="93%">&nbsp;</td>
  </tr>
  <tr>
    <td>MEDIFESTRUCTURAS</td>
  </tr>
  <tr>
    <td>6 de diciembre y Bosmediano</td>
  </tr>
  <tr>
    <td>3-B</td>
  </tr>
...
<table width="97%" border="0">
  <tr>
    ...
    <p>En la llamada le informaremos con detalle sobre nuestra propuesta.</p>
    <p>El objetivo es ayudar a aquellos ingenieros y arquitectos que deseen realizar un efoque digital de su profesión.</p>
    <p>Disponiendo de una página web ya programada para desarrollar todas las funciones de consultor internacional.</p>
    <p>Es necesario CONFIRMAR la reserva de la llamada:</p>
    <BR>
    </td>
    <td width="21%">
...
<table width="97%" border="1">
 <tr>
  ...
  <tr>
    <td  bgcolor="#03F" style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#FFF ; font-size:0.9em; text-align:right;padding-right:0.2em; vertical-align:top">Nuestro usuario Skype/Zoom</td>
...
<p>Director de Medifestructuras </p>
