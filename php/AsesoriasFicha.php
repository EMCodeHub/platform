...
if (!isset($_REQUEST['volver_a'])) {
	$_REQUEST['volver_a'] = "AsesoriasLista.php";
} else {
	if ($_REQUEST['volver_a']="") {
	    $_REQUEST['volver_a'] = "AsesoriasLista.php";	
	}
}
include_once('../php/AsesoriasScrip.php');
...
echo "<br>";
	...
	echo '<form id = "datos" name= "datos" action="AsesoriasLista.php" method="post">';
    ...
    $query = 'show columns FROM asesoriasesiones';
