...
function SesValidaObservaciones() {
	...
	if (pais.length < 3) {
		$("#SesMensaje").html("<span class='rojo'>Indíquenos información adicional sobre usted</span>");
...
function RealizaGestion() {
  var parametros = {
	...
	$.ajax({
             data:  parametros,
             url:   '../php/AsesoriaSolicitudAltaSesioncypeee.php',
             type:  'post',
			 async:  false,
             beforeSend: function () {
...
function SesResuelveBodyCarta()	{
  var parametros = {
		...
		$.ajax({
             data:  parametros,
             url:   '../cartas/CartaAsesoriaSesioncypeee.php',
             type:  'post', 
			 async: false,
             beforeSend: function () {
...
function SesEnviaCartas()	{
  var parametros = {
	...
	$.ajax({
             data:  parametros,
             url:   '../php/AsesoriaSesionEnviaMailcypeee.php',
             type:  'post',
			 async: false,
             beforeSend: function () {
