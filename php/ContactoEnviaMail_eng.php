...
if ($totMaestros == 1) {
       ...
       //....correo para el cliente...................................................................
          ...
          if ($rowRegistros['es_pop3'] > 0) {
			   $mail->Helo        = "www.mail.cype.com";
			   $mail->Host       = $rowRegistros['servidor']; 
               $mail->Port       = $rowRegistros['puerto'];
               $mail->Username   = $rowRegistros['usuario']; // SMTP account username 
               $mail->Password   = $rowRegistros['password'];        // SMTP account password
          }
          ...
          $mail->Subject = 'Medif: Data of your query or request.';
          ...
          if(!$exito) {
       	    echo "ERROR:".$mail->ErrorInfo;
			       ...
			       //......................................correo para Medif...........................................................................
             $mail->Subject = '(QUERY) Customer Letter:'.$_POST['nombre']." ".$_POST['apellidos'];
