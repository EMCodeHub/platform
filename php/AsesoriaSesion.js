...
//.......................................................................
function SesValidaUsuSkype(){
 	$("#SesMensaje").html("&nbsp;");  
	var usuario = $("#SesUsuSkype").val();
	if (usuario.length < 4 ) {
		$("#SesMensaje").html("<span class='rojo'>Informe un usuario Skype</span>");
        $("#SesUsuSkype").focus();
		return false;
	}
	return true;
...
function SesValidaObservaciones() {
	...
	if (pais.length < 3) {
		$("#SesMensaje").html("<span class='rojo'>Informe el tema a tratar</span>");
...
function RealizaGestion() {
  var parametros = {
	...
	$.ajax({
             data:  parametros,
             url:   '../php/AsesoriaSolicitudAltaSesion.php',
             type:  'post',
			 async:  false,
             beforeSend: function () {
...
function SesEnviaCartas()	{
  var parametros = {
	...
	$.ajax({
             data:  parametros,
             url:   '../php/AsesoriaSesionEnviaMail.php',
             type:  'post',
			 async: false,
             beforeSend: function () {
