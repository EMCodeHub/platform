...
$order_id = 4528; //será el número de solicitud
$curso_id = 4;
$action = "https://www.2checkout.com/checkout/purchase";
$name="Pago servicios  lote pruebas a 1$";
$id = 102909160;
$description = "Prueba curso 1 a 1$";
$price = 1;
$error = "";
$real_test = "-T-"; 
$paginaRespuesta = "https://medifestructuras.com/php/RespuestaCobro2Check.php"; 
