...
$(document).ready(function(){
   ...
   $("#TusApellidos").change(function() { LDValidaTusApellidos(); });
   $("#TuTfn").change(function() { LDValidaTelefono(); });
   $("#TuCorreo").change(function() { LDVerificarDireccionCorreo(); });
   $('#TuPais').change(function() { LDValidaPais(); });
//.....................................
   $( "#TuTfn" ).keypress(function() { LDsolonumeros(); });
   //..............
...
function LDValidaTusApellidos() {
	$("#mensajeLanding").html("");  
	var apellidos = LDtrim($("#TusApellidos").val());
	if ( LDtrim(apellidos).length <3 ) {
		$("#mensajeLanding").html("<span class='rojo'>Informe los apellidos</span>");
		return false;
	}
	if ( FormatoTxtValido(apellidos) == false) {
		$("#mensajeLanding").html("<span class='rojo'>Formato Apellidos incorrecto</span>");
		return false;
	}
	return true;
}
...
//.......................................................................................................
function LDValidaPais() {
	$("#mensajeLanding").html(""); 
	var pais = LDtrim($("#TuPais").val());
	if (pais.length < 3) {
		$("#mensajeLanding").html("<span class='rojo'>Informe su país</span>");
		return false;
	}
	if (FormatoTxtValido(pais) == false) {
		$("#mensajeLanding").html("<span class='rojo'>Formato Pais incorrecto</span>");
		return false;
	}
	return true;
...
//.......................................................................................................
function LDValidaTelefono() {
	$("#mensajeLanding").html("");  
	var telefono = $("#TuTfn").val();
	if (telefono.length < 6 || telefono.length > 12 ) {
		$("#mensajeLanding").html("<span class='rojo'>El Teléfono no parece correcto</span>");
		return false;
	}
	return true;
}
