...
///////////////////MaestrosLista///////////////////////////////////////////////////
function pintaIvaPaises($conexion) {
...
if ($_REQUEST['operacion'] == "UPDATE"){
    $FormatMaestros = "UPDATE  vtpaisesiva SET ";
    $n = 0;
	$ValorGrabar = "";
...
if ($_REQUEST['operacion'] == "INSERT"){
	    $FormatMaestros = "INSERT INTO vtpaisesiva (";
    $n = 0;
    for( $i = 0; $i < $nColumnas ; $i++ ) {
	     if($n == 0){
		    $coma = "";
...
$FormatMaestros = "select id, codigo_pais, ciudad, nombre_iva, iva from vtpaisesiva order by codigo_pais";
