...
///////////////////MaestrosLista///////////////////////////////////////////////////
function pintaUsuarios($conexion) {
...
if ($_REQUEST['operacion'] == "UPDATE"){
    $FormatMaestros = "UPDATE  usuarios SET ";
    $n = 0;
	$ValorGrabar = "";
...
if ($_REQUEST['operacion'] == "INSERT"){
	    $FormatMaestros = "INSERT INTO usuarios (";
    $n = 0;
    for( $i = 0; $i < $nColumnas ; $i++ ) {
	     if($n == 0){
		    $coma = "";
...
$FormatMaestros = "select id,	nombre_usuario, pwd,	es_admin,	referencia_interna,	fecha_alta,	fecha_baja from usuarios";
