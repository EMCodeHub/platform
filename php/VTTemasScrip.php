...
///////////////////MaestrosLista///////////////////////////////////////////////////
function pintaVTTemas($conexion) {
...
if ($_REQUEST['operacion'] == "UPDATE"){
    $FormatMaestros = "UPDATE  vtcurmodbloqtema SET ";
    $n = 0;
	$ValorGrabar = "";
...
if ($_REQUEST['operacion'] == "INSERT"){
	    $FormatMaestros = "INSERT INTO vtcurmodbloqtema (";
    $n = 0;
    for( $i = 0; $i < $nColumnas ; $i++ ) {
	     if($n == 0){
		    $coma = "";
...
$FormatMaestros = "SELECT  id, vtcurmodbloqtema.esta_activo, id_vtcurmodbloque, orden_tema, es_de_pago, titulo_tema, ficheroPDF 
                   FROM    vtcursomodulo, vtcursos, vtcurmodbloque, vtcurmodbloqtema
				   ...
				   ORDER   BY orden, orden_mod, orden_bloc, orden_tema";
    ...
    if ($_REQUEST['filtro'] == "FILTRO_ID" && $_REQUEST['id_vtcurmodbloque'] !=0) {
	    ...
	    $FormatMaestros = "SELECT  id, esta_activo, id_vtcurmodbloque, orden_tema, es_de_pago, titulo_tema, ficheroPDF    
...
function Descripcion3Modulo($idRegistro,$conexion) {
   ...
   $FormatVTCursos = "SELECT titulo_mod 
                      FROM vtcursomodulo, vtcurmodbloque, vtcurmodbloqtema
...
function Descripcion3Bloque($idRegistro,$conexion) {
   ...
   $FormatVTCursos = "SELECT titulo_bloc 
                       FROM vtcurmodbloque, vtcurmodbloqtema
